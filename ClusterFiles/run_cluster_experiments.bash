...
# sbatch --export=ALL,experiment="exp3",func_name="rosenbrock",method="NNnorm",replace_mech="Random",D=30,runs=30,frequency=1,max_times=100,nn_window=5,nn_nf=4,nn_pick=3,nn_sample_size=1,save="True",pbar="False",silent="False",cluster="True",nn_train_window=None,freqSave=1,batch_size=4,nn_epochs=3 cluster_job.sh
# sbatch --export=ALL,experiment="exp3",func_name="sphere",method="NNnorm",replace_mech="Random",D=30,runs=30,frequency=1,max_times=100,nn_window=5,nn_nf=4,nn_pick=3,nn_sample_size=1,save="True",pbar="False",silent="False",cluster="True",nn_train_window=None,freqSave=1,batch_size=4,nn_epochs=3 cluster_job.sh
# sbatch --export=ALL,experiment="exp3",func_name="rastrigin",method="NNnorm",replace_mech="Random",D=30,runs=30,frequency=1,max_times=100,nn_window=5,nn_nf=4,nn_pick=3,nn_sample_size=1,save="True",pbar="False",silent="False",cluster="True",nn_train_window=None,freqSave=1,batch_size=4,nn_epochs=3 cluster_job.sh
