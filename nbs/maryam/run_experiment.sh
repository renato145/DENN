...
#exp1
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 sphere --method NNnorm --replace_mech Worst --diversity_method RI --runs 1  --nn_window 5 --nn_train_window 1 --nn_pick 5 --nn_sample_size 3 --nn_epochs 3 --batch_size 4 --freq_save 0.5 --frequency 0.5
