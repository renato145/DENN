...
#exp1
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 noNNReval  --runs 30 --frequency 1200
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 noNNRestart  --runs 30 --frequency 1200
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 NNnorm  Worst --runs 30 --frequency 1000
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 NNdrop  Worst --runs 30 --frequency 1000
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 NNnorm  Closest --runs 30 --frequency 1000
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 NNdrop  Closest --runs 30 --frequency 1000
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 NNnorm  Random --runs 30 --frequency 1000
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 NNdrop  Random --runs 30 --frequency 1000
