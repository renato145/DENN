...
#exp1
~/anaconda3/envs/DENN/bin/python run_experiment.py exp2 sphere NNnorm  Random --runs 1 --frequency 1000 --nn_window 5 --nn_train_window 5 --nn_sample_size 2 --nn_epochs 3 --batch_size 4 --freq_save=1000
