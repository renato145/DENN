...
#exp1
~/anaconda3/envs/DENN/bin/python run_experiment.py exp1 sphere --method NNnorm --replace_mech Random --diversity_method Rst --runs 1 --frequency 20 --nn_window 5 --nn_train_window 5 --nn_pick 3 --nn_sample_size 3 --nn_epochs 3 --batch_size 4 --freq_save=20
